...
import { ChevronLeft, ChevronRight, Calendar, Clock, User, MapPin, Video, Phone, FileText, Bell, Briefcase, Building, Menu, X } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchInterviews = async () => {
      try {
        ...
        const response = await api.get('/candidates/candidate_interview_calendar/', {
          headers: {
                    ...
                    interviews.slice(0, 5).map((interview) => (
                      <div key={interview.id} className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="font-medium text-gray-900 text-sm">{interview.company_name}</span>
                        </div>
                        <div className="flex items-center space-x-2 mb-2">
                            ...
                            {interviews.slice(0, 1).map((interview) => (
                              ...
                              >
                                ...
                                <div className="hidden sm:flex items-center space-x-1 mb-1">
                                  <Building className="w-3 h-3 text-green-800" />
                                  <span className="font-medium truncate text-green-900">{interview.company_name}</span>
                                </div>
                                ...
                                <div className="sm:hidden text-[10px] truncate">{interview.company_name}</div>
                              </div>
                            ))}
                            {interviews.length > 1 && (
                          ...
                          <div className="space-y-1 sm:space-y-2">
                            {interviews.map((interview) => (
                              ...
                              >
                                ...
                                <div className="flex items-center space-x-1 sm:space-x-2 mb-1 sm:mb-2">
                                  <Building className="w-3 h-3 sm:w-4 sm:h-4 text-green-800" />
                                  <span className="font-medium text-green-900 truncate text-[10px] sm:text-sm">{interview.company_name}</span>
                                </div>
                        ...
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 space-y-2 sm:space-y-0">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="font-medium text-green-900">{interview.company_name}</span>
                            </div>
                        ...
                        <div className="flex items-center space-x-3">
                          <div>
                            <div className="flex items-center space-x-2 mb-1">
                              ...
                              <span className="font-medium text-green-900 text-sm sm:text-base">{interview.company_name}</span>
                            </div>
                            <div className="flex items-center space-x-2">
